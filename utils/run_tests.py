...
# Centralized, safe, relative paths
RESULTS_DIR = Path("utils/results")
REPORT_DIR = Path("utils/reports/allure")
...
def main():
    ...
    if use_allure:
        ...
        print(f"✅ Allure report generated at: http://127.0.0.1:5500/utils/reports/allure/index.html")
